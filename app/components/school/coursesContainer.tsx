              ...
              <DialogHeader>
                <div className="flex flex-row gap-2 ">
                  <div
                    ...
                    style={{ backgroundColor: course.course_color }}
                  ></div>
              ...
              >
                <Badge className="flex items-center gap-2 h-8 bg-accent/30">
                  <div
                    ...
                    style={{ backgroundColor: courseToEdit.course_color }}
                  ></div>
                  <span>{courseToEdit.course_code}</span>
                  <span className="text-muted-foreground">-</span>
                  <span className="text-card-foreground">
                    {courseToEdit.course_name}
                  </span>
                </Badge>
              </DialogTrigger>
                ...
                <DialogHeader>
                  <div className="flex flex-row gap-2 ">
                    <div
                      ...
                      style={{ backgroundColor: course.course_color }}
                    ></div>
                    <DialogTitle>Update {courseToEdit.course_name}</DialogTitle>
                  </div>
                  <DialogDescription>
                    Here you can update or delete the course you have selcted.
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-row gap-2 mt-4 items-center justify-center w-full ">
                    <Button
                      className="bg-primary/20 hover::cursor-pointer hover:bg-red-600"
                      onClick={() => {
                        setOpen(!open);
                        deleteCourse.mutate({ id: course.id, userId: user_id });
                      }}
                      type="submit"
                      variant={"default"}
                    >
