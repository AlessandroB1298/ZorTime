        ...
        <Card className="m-3 ">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-3">
                {courses.map(course => (
                  <Badge key={course.id} className="flex items-center gap-2 h-8 bg-accent/30">
                    <div className={`w-4 h-4 rounded `} style={{backgroundColor: course.course_color}}></div>
                    <span>{course.course_code}</span>
                    <span className="text-muted-foreground">-</span>
                    <span className="text-card-foreground">{course.course_name}</span>
                  </Badge>
                ))}
              </div>
            </CardContent>
